...
function blueworx_apply_admin_menu_visibility() {
	...
	if ( ! empty( $toggled_items ) ) {
		...
		add_menu_page(
			esc_html__( 'More', 'blueworx-enhancements' ),
			esc_html__( 'More', 'blueworx-enhancements' ),
			'read',
			'blueworx-menu-toggle',
...
function blueworx_render_toggle_menu_page() {
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'More', 'blueworx-enhancements' ); ?></h1>
		<p><?php esc_html_e( 'Use the submenu items here to open menus moved into More.', 'blueworx-enhancements' ); ?></p>
	</div>
	<?php
}
