...
function blueworx_enqueue_admin_theme() {
	...
	// The top bar's breadcrumb divider is a design-system icon, and the bar is on
	// every admin screen — including the ones that do not load the rest of the
	// system. Without the module the divider is an empty span.
